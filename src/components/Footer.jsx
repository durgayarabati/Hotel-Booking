...
const Footer = () => {
    return (
        <div className='bg-[#F5F5F5] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='mb-4 h-8 md:h-9' />
                    <p className='text-sm'>
                        Discover the best stays around the world with Staybnb. Book unique homes, experiences, and places to stay.
                    ...
                    <div className='flex items-center gap-3 mt-4'>
                        ...
                        <img src={assets.linkendinIcon} alt="linkendin" className='w-6'/>
