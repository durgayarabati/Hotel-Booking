...
const Testimonial = () => {
  return (
    <div>
        <Title title="What Our Guest Say" subtitle="The world’s best hotels 
        offer extraordinary luxury, exceptional service, stunning design, 
        and unforgettable experiences in breathtaking locations."/>
